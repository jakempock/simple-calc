...
function _emscripten_get_screen_size(width, height) {
 SAFE_HEAP_STORE(width | 0, screen.width | 0, 4);
 SAFE_HEAP_STORE(height | 0, screen.height | 0, 4);
}
...
function registerTouchEventCallback(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) {
 ...
 var touchEventHandlerFunc = function(e) {
  ...
  SAFE_HEAP_STORE_D(touchEvent | 0, +e.timeStamp, 8);
  ...
  SAFE_HEAP_STORE(touchEvent + 8 | 0, numTouches | 0, 4);
  if (function(a1, a2, a3) {
   return dynCall_iiii.apply(null, [ callbackfunc, a1, a2, a3 ]);
